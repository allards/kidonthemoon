...
// Filename: simplex_v5_withstar icon.ggsk
// Generated Fri Apr 29 07:54:01 2016
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._tt_stop_auto_rotate.ggUpdateConditionTimer=function () {
			...
			if (me._tt_stop_auto_rotate.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._tt_stop_auto_rotate.ggCurrentLogicStateVisible == 0) {
					me._tt_stop_auto_rotate.style.visibility="inherit";
		...
		this._tt_start_auto_rotate.ggUpdateConditionTimer=function () {
			...
			if (me._tt_start_auto_rotate.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._tt_start_auto_rotate.ggCurrentLogicStateVisible == 0) {
					me._tt_start_auto_rotate.style.visibility="inherit";
		...
		this._info.onclick=function () {
			...
			me._userdata.style.visibility='inherit';
			me._userdata.ggVisible=true;
			me._screentint.style[domTransition]='none';
			me._screentint.style.visibility='inherit';
		...
		this._tt_movemode0.ggUpdateConditionTimer=function () {
			...
			if (me._tt_movemode0.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._tt_movemode0.ggCurrentLogicStateVisible == 0) {
					me._tt_movemode0.style.visibility="inherit";
		...
		this._screentint_1=document.createElement('div');
		this._screentint_1.ggId="screentint_1";
		this._screentint_1.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._screentint_1.ggVisible=false;
		this._screentint_1.className='ggskin ggskin_rectangle ';
		this._screentint_1.ggType='rectangle';
		hs ='';
		...
		hs+='visibility : hidden;';
		hs+='width : 100%;';
		this._screentint_1.setAttribute('style',hs);
		this._screentint_1.style[domTransform + 'Origin']='50% 50%';
		me._screentint_1.ggIsActive=function() {
			return false;
		}
		me._screentint_1.ggElementNodeId=function() {
			return me.player.getCurrentNode();
		}
		this._screentint_1.ggUpdatePosition=function () {
		}
		this.divSkin.appendChild(this._screentint_1);
		...
		this._loading_image_1=document.createElement('div');
		this._loading_image_1__img=document.createElement('img');
		this._loading_image_1__img.className='ggskin ggskin_svg';
		this._loading_image_1__img.setAttribute('src',basePath + 'images/loading_image_1.svg');
		this._loading_image_1__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;');
		this._loading_image_1__img['ondragstart']=function() { return false; };
		this._loading_image_1.appendChild(this._loading_image_1__img);
		this._loading_image_1.ggId="loading_image_1";
		this._loading_image_1.ggLeft=-20;
		this._loading_image_1.ggTop=-20;
		this._loading_image_1.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._loading_image_1.ggVisible=true;
		this._loading_image_1.className='ggskin ggskin_svg ';
		this._loading_image_1.ggType='svg';
		hs ='';
		hs+='height : 40px;';
		hs+='left : -20px;';
		hs+='position : absolute;';
		...
		hs+='visibility : inherit;';
		hs+='width : 40px;';
		this._loading_image_1.setAttribute('style',hs);
		this._loading_image_1.style[domTransform + 'Origin']='50% 50%';
		me._loading_image_1.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._loading_image_1.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		this._loading_image_1.ggUpdatePosition=function () {
			this.style[domTransition]='none';
			if (this.parentNode) {
				var w=this.parentNode.offsetWidth;
					this.style.left=(this.ggLeft - 0 + w/2) + 'px';
		...
		this._image_popup.appendChild(this._loading_image_1);
	...
	function SkinHotspotClass(skinObj,hotspot) {
		...
		if (hotspot.skinid=='ht_image') {
			...
			this.__div.onclick=function () {
				...
				me._hsimage_image.style.visibility='hidden';
				me._hsimage_image.ggVisible=false;
				me._hstext_image.style[domTransition]='none';
		...
		} else
		{
			...
			this._hsimage_url.ggParameter={ rx:0,ry:0,a:0,sx:2,sy:2 };
			...
			this._hsimage_url.style[domTransform]=parameterToTransform(this._hsimage_url.ggParameter);
			...
			this._hsimage_url.onclick=function () {
				me.player.openUrl("http:\/\/www.kidonthemoon.org\/backtoearth\/index.html","");
			}
			this._hsimage_url.onmouseover=function () {
				me._hstext_url.style[domTransition]='none';
				me._hstext_url.style.visibility='inherit';
				me._hstext_url.ggVisible=true;
			}
			this._hsimage_url.onmouseout=function () {
				me._hstext_url.style[domTransition]='none';
			...
			this._hstext_url.ggVisible=false;
			...
			hs+='background: rgba(85,85,255,0.705882);';
			hs+='border: 4px solid #5555ff;';
